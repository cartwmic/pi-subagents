# subagent-parallel-recovery Specification

## Purpose

Define recovery behavior for parallel subagent execution when a task fails, a child reports an error-terminal message, or a caller aborts running work.
